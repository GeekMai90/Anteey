...
export const useDictionaryStore = defineStore('dictionary', () => {
  ...
  const fetchPendingSuggestions = async (): Promise<WordSuggestion[]> => {
    try {
      loading.value = true
      error.value = null
      const result = await window.electronAPI.getPendingSuggestions()
  ...
  const processSuggestion = async (
    ...
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.processSuggestion(word, status)
    } catch (err) {
      error.value = '处理建议失败'
  ...
  const processSuggestionBatch = async (
    ...
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.processSuggestionBatch(words, status)
    } catch (err) {
  ...
  const fetchDictionary = async () => {
    try {
      loading.value = true
      error.value = null
      dictionary.value = await window.electronAPI.getDictionary()
    } catch (err) {
      error.value = '获取词典失败'
  ...
  const cleanupDictionary = async (days: number = 30) => {
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.cleanupDictionary(days)
      // 刷新数据
  ...
  const fetchAllWords = async () => {
    try {
      loading.value = true
      error.value = null
      return await window.electronAPI.getAllWords()
    } catch (err) {
      error.value = '获取词典失败'
      console.error('获取词典失败:', err)
      return []
  ...
  const addWord = async (word: string) => {
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.addWord(word)
    } catch (err) {
      error.value = '添加词条失败'
  ...
  const deleteWords = async (words: string[]) => {
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.deleteWords(words)
    } catch (err) {
  ...
  const updateWordStatus = async (word: string, enabled: boolean) => {
    try {
      loading.value = true
      error.value = null
      await window.electronAPI.updateWordStatus(word, enabled)
    } catch (err) {
