<template>
  <div class="quote-template" :style="[cardStyle, { backgroundImage: `url(${backgroundImage})` }]">
...
import backgroundImage from '@renderer/assets/share/quoteBackground.png'
