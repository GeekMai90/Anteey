<template>
  <div class="mario-question-box" :class="{ active: modelValue }">
    <div class="button">
      <button type="button" :aria-label="label" @click="handleClick"></button>
      <span></span>
      <span></span>
      <span></span>
      <span></span>
...
const handleClick = () => {
  // 只在开启音效时播放
  if (reviewStore.enableMarioSound) {
    ...
    & > span:nth-child(4) {
      ...
      &::after {
        ...
        box-shadow:
          ...
          -0.5em 0 var(--stone-800),
          -0.75em 0 var(--stone-800),
          -1em 0 var(--stone-800),
          -1.25em 0 var(--stone-800),
          -1.5em 0 var(--stone-800),
          -1.25em -0.25em var(--stone-800),
          -1em -0.5em var(--stone-800),
          -0.75em -0.75em var(--stone-800),
          -1.25em 0.25em var(--stone-800),
          -1em 0.5em var(--stone-800),
          -0.75em 0.75em var(--stone-800);
      }
