            ...
            >
              <div class="note-title">
                <div class="result-preview-icon-note">
                  <BankCard theme="outline" size="12" fill="#888" :strokeWidth="3" />
                </div>
              ...
              >
                <div class="result-preview">
                  <div class="result-preview-icon">
                    <ParagraphRectangle theme="outline" size="14" fill="#666" :strokeWidth="3" />
                  </div>
                  <!-- <span v-html="highlightMatch(block.content, searchQuery)"></span> -->
