...
var LeaderLine = (function () {
  ...
  var Z,
    ...
    g =
      ...
      (x = 0),
      {
        add: function (n, e, t, a, i, o, l) {
          ...
          if (('string' == typeof i && (i = _[i]), (n = n || function () {}), t < v))
            r = [g(0, 0), g(1, 1)]
          else {
            if (
              ((s = v / t), (r = [g(0, 0)]), 0 === i[0] && 0 === i[1] && 1 === i[2] && 1 === i[3])
            )
          ...
          return (
            E.push(
              (o = { animId: S, frameCallback: e, duration: t, count: a, frames: r, reverse: !!o })
            ),
            !1 !== l && be(o, l),
            S
          )
              ...
              return (
                ...
                (n
                  ...
                  : ((a = (Date.now() - e.framesStart) / e.duration),
                    (a = e.reverse ? 1 - a : a) < 0 ? (a = 0) : 1 < a && (a = 1)),
                !(e.framesStart = null))
              )
            }),
            a
                  ...
                  : 'C' === e.type
                    ...
                    : 'L' === e.type
                      ? ((r = e.values[0]),
                        ...
                        (f = s))
                      : 'H' === e.type
                        ? ((r = e.values[0]), u.push({ type: 'L', values: [r, f] }), (d = r))
                        : 'V' === e.type
                          ? ((s = e.values[0]), u.push({ type: 'L', values: [d, s] }), (f = s))
                          : 'S' === e.type
                            ? ((t = e.values[0]),
                              (n = e.values[1]),
                              (r = e.values[2]),
                              ...
                              : 'Q' === e.type
                                ...
                                : 'A' === e.type
                                  ? ((n = e.values[0]),
                                    ...
                                    (s = e.values[6]),
                                    0 === n || 0 === a
                                      ? (u.push({ type: 'C', values: [d, f, r, s, r, s] }),
                                        (d = r),
                                        (f = s))
                                      : (d === r && f === s) ||
          ...
          var s = e.SVGPathElement.prototype.setAttribute,
            ...
            b = function (e, t, n, a, i, o, l, r, s, u) {
                ...
                : ((e = (m = h(e, t, -p)).x),
                  ...
                  (S =
                    ((f =
                      (r === s ? -1 : 1) *
                      Math.sqrt(
                        Math.abs((f * m - f * d * d - m * y * y) / (f * d * d + m * y * y))
                      )) *
                      i *
                      d) /
                      o +
              ...
              Math.abs(m) > (120 * Math.PI) / 180 &&
                ...
                (y = a),
                (v =
                  s && _ < v ? _ + ((120 * Math.PI) / 180) * 1 : _ + ((120 * Math.PI) / 180) * -1),
                (n = S + i * Math.cos(v)),
                (a = g + o * Math.sin(v)),
              ...
              return (
                c.forEach(function (e, t) {
                  t % 2 ? x.push(h(c[t - 1], c[t], p).y) : x.push(h(c[t], c[t + 1], p).x),
            ...
            (e.SVGRectElement.prototype.getPathData = function (e) {
              var t = this.x.baseVal.value,
                ...
                n = (n = [
                  ...
                  { type: 'H', values: [t + a - o] },
                  { type: 'A', values: [o, (l = i / 2 < l ? i / 2 : l), 0, 0, 1, t + a, n + l] },
                  { type: 'V', values: [n + i - l] },
        ...
        [
          function (e, t, n) {
            ...
            t.default = {
              ...
              remove: function (e) {
                ;-1 < (e = h(e)) &&
                  (i.splice(e, 1), !i.length && s && (l.call(window, s), (s = null)))
              }
            }
          }
        ]),
    ...
    fe = { show_on: {}, show_effect: {}, show_animOptions: {}, show_animId: {}, show_inAnim: {} },
    ye = 'fade',
    me = [],
    Se = {},
    ge = 0,
      ...
      E.forEach(function (e) {
        ...
        if (e.framesStart) {
          if ((t = i - e.framesStart) >= e.duration && e.count && e.loopsLeft <= 1)
            return (
              (a = e.frames[(e.lastFrame = e.reverse ? 0 : e.frames.length - 1)]),
  ...
  function Oe(e) {
    ...
    function l(e) {
      ...
      return (
        e &&
          ((t = parseFloat(e[1])),
          e[2] ? (t = 0 <= t && t <= 100 ? t / 100 : 1) : (t < 0 || 1 < t) && (t = 1)),
        t
      )
    }
    return (
            ...
            : 'hsla' === n && 4 === a.length
              ...
              : 'hwb' === n && 4 === a.length
                ...
                : 'gray' === n && 2 === a.length
                  ...
                  : 'device-cmyk' === n &&
                    5 <= a.length &&
                    ((i = l(a[4])), (o = 'device-cmyk(' + a.slice(0, 4).join(', ') + ')')))
  ...
  function Ve(e, t, n) {
    var a = t.x - e.x,
      t = t.y - e.y
    return { x: e.x + a * n, y: e.y + t * n, angle: Math.atan2(t, a) / (Math.PI / 180) }
  }
  function Pe(e, t, n) {
  ...
  function We(e, t, n, a, i) {
    for (var o, l = 0.5, r = 1 - l; (o = Te(e, t, n, a, r)), !(Math.abs(o - i) <= 0.01); )
      r += (o < i ? 1 : -1) * (l /= 2)
    return r
  }
  function Be(e, t) {
        ...
        ;(n = n || [{ type: 'M', values: [e[0].x, e[0].y] }]).push(
          e.length
            ? 2 === e.length
              ...
              : { type: 'C', values: [e[1].x, e[1].y, e[2].x, e[2].y, e[3].x, e[3].y] }
            : { type: 'Z', values: [] }
        )
      }),
      n
  ...
  function Ue(e, t, n, a, i, o, l) {
    ...
    'auto-start-reverse' === n
      ? ('boolean' != typeof s &&
          ...
          (s = t.orientType.baseVal === SVGMarkerElement.SVG_MARKER_ORIENT_UNKNOWN)),
        s
            ...
            p.socketSE[e] ||
              (c[e].width || c[e].height
                ...
                : ((t = v[e ? 0 : 1].x - c[e].left),
                  (n = v[e ? 0 : 1].y - c[e].top),
                  (v[e].socketId = Math.abs(t) >= Math.abs(n) ? (0 <= t ? k : A) : 0 <= n ? L : b)))
          })),
            ...
            for (
              ...
              (function () {
                ...
                if (o[0] === o[1]) {
                  ...
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      (a = m(u[t.notContain], u[t.contain], o[t.notContain])) < ee &&
                        (u[t.notContain] = c(u[t.notContain], ee - a)),
                      ...
                      (u[t.notContain] = c(
                        ...
                        f(u[t.contain], u[t.notContain])
                          ? 'x' === o[t.notContain]
                            ? r
                            : l
                          : S(u[t.notContain], u[t.contain], 'x' === o[t.notContain] ? 'y' : 'x')
                      )))
                  ...
                  if (n[0] && n[1])
                    return void (f(u[1], u[0])
                      ...
                      : f(u[0], u[1])
                        ? s[0].push(u[0])
                        : s[0].push(
                            'x' === o[0] ? { x: u[1].x, y: u[0].y } : { x: u[0].x, y: u[1].y }
                          ))
                  n[0] !== n[1]
                    ? ((t = y(n)),
                      s[t.notContain].push(u[t.notContain]),
          ...
          0 < e
            ? 2 === (n = _[(a = p ? 0 : _.length - 1)]).length
              ...
              : ((d[a] = d[a] || Te.apply(null, n)),
                d[a] > $ &&
                  (d[a] - e < $ && (e = d[a] - $),
                  (s = Ne(n[0], n[1], n[2], n[3], We(n[0], n[1], n[2], n[3], p ? e : d[a] - e))),
                  ...
                  (_[a] = p ? [s, s.toP1, s.toP2, n[3]] : [n[0], s.fromP1, s.fromP2, s]),
                  (d[a] = null)))
            : e < 0 &&
              ((n = _[(a = p ? 0 : _.length - 1)]),
              (s = v[t].socketId),
              (t = -c[t]['x' == (u = s === A || s === k ? 'x' : 'y') ? 'width' : 'height']),
              (h = (e = e < t ? t : e) * (s === A || s === b ? -1 : 1)),
              2 === n.length
                ? (n[p ? 0 : n.length - 1][u] += h)
                : (p ? [0, 1] : [n.length - 2, n.length - 1]).forEach(function (e) {
                    n[e][u] += h
                  }),
              (d[a] = null))
        }),
  ...
  function $e(e, t) {
    ...
    t.line &&
      (U.line =
        ...
        (l = Xe(n, a, 'line_strokeWidth', i.lineSize, o.cur_line_strokeWidth) || l))),
      (t.plug || U.line) &&
        (U.plug =
          ((p = (h = e).options),
          (c = h.curStats),
      ...
      (t.lineOutline || U.line) &&
        (U.lineOutline =
          ...
          (k = Xe(i, l, 'lineOutline_colorTra', Oe(l.lineOutline_color)[0] < 1) || k),
          (o = l.line_strokeWidth * o.lineOutlineSize),
          (k = Xe(i, l, 'lineOutline_strokeWidth', l.line_strokeWidth - 2 * o) || k),
          (k =
            Xe(
              i,
              l,
              'lineOutline_inStrokeWidth',
              l.lineOutline_colorTra ? l.lineOutline_strokeWidth + 2 * se : l.line_strokeWidth - o
            ) || k))),
                ...
                (y =
                  Xe(
                    ...
                    u.plugOutline_colorTraSE[e]
                      ? t - (se / (u.line_strokeWidth / ue.lineSize) / s.plugSizeSE[e]) * 2
                      : t / 2
                  ) || y))
          }),
          y)),
      (t.faces || U.line || U.plug || U.lineOutline || U.plugOutline) &&
        (U.faces =
          ...
          Xe(m, _, 'line_strokeWidth', (S = g.line_strokeWidth), v.apl_line_strokeWidth) &&
            ((m.lineShape.style.strokeWidth = S + 'px'),
            (E = !0),
            (oe || ie) && (je(m, m.lineShape), ie && (je(m, m.lineFace), je(m, m.lineMaskCaps)))),
          Xe(m, _, 'lineOutline_enabled', (S = g.lineOutline_enabled), v.apl_lineOutline_enabled) &&
            ((m.lineOutlineFace.style.display = S ? 'inline' : 'none'), (E = !0)),
          g.lineOutline_enabled &&
            (Xe(m, _, 'lineOutline_color', (S = g.lineOutline_color), v.apl_lineOutline_color) &&
          ...
          g.plug_enabled &&
            [0, 1].forEach(function (n) {
              var e = g.plug_plugSE[n],
                t = e !== Y ? X[q[e]] : null,
                a = Ze(n, t)
              Xe(m, _.plug_enabledSE, n, (S = g.plug_enabledSE[n]), v.apl_plug_enabledSE) &&
                ((m.plugsFace.style[a.prop] = S ? 'url(#' + m.plugMarkerIdSE[n] + ')' : 'none'),
                (E = !0)),
                g.plug_enabledSE[n] &&
                  (Xe(m, _.plug_plugSE, n, e, v.apl_plug_plugSE) &&
                    ...
                    (E = !0),
                    oe && je(m, m.plugsFace)),
                  Xe(m, _.plug_colorSE, n, (S = g.plug_colorSE[n]), v.apl_plug_colorSE) &&
                  ...
                  Xe(
                    ...
                    (S
                      ? ((m.plugFaceSE[n].style.mask = 'url(#' + m.plugMaskIdSE[n] + ')'),
                  ...
                  g.plugOutline_enabledSE[n] &&
                    ...
                    Xe(
                      ...
                      (E = !0),
                      ie && (je(m, m.lineMaskCaps), je(m, m.lineOutlineMaskCaps))),
                    Xe(
                      m,
                    ...
                    ) && ((m.plugOutlineMaskShapeSE[n].style.strokeWidth = S + 'px'), (E = !0)),
                    Xe(
                      m,
                    ...
                    ) && ((m.plugMaskShapeSE[n].style.strokeWidth = S + 'px'), (E = !0))))
            }),
          E)),
        ...
        (U.path =
          ...
          M &&
            ...
            Fe(b, I.path_pathData) &&
              ...
              (I.path_pathData = b),
              (C = !0),
              ie ? (je(x, x.plugsFace), je(x, x.lineMaskCaps)) : oe && je(x, x.linePath),
              x.events.apl_path &&
      ...
      (U.viewBox =
        ...
        ['x', 'y', 'width', 'height'].forEach(function (e) {
          ...
          ;(t = L[e]) !== A[e] &&
            ((V[e] = A[e] = t),
            (P[Q[e]] = t + ('x' === e || 'y' === e ? O.bodyOffset[e] : 0) + 'px'),
            (N = !0))
        }),
        N)),
      (U.mask =
        ...
        R.plug_enabled
          ...
          : (R.capsMaskMarker_enabledSE[0] = R.capsMaskMarker_enabledSE[1] = !1),
        (R.capsMaskMarker_enabled = R.capsMaskMarker_enabledSE[0] || R.capsMaskMarker_enabledSE[1]),
        ...
        ((R.lineMask_enabled && !R.lineMask_outlineMode) || R.lineOutline_enabled) &&
        ...
        R.lineMask_enabled &&
          (Xe(W, F, 'lineMask_outlineMode', (B = R.lineMask_outlineMode)) &&
            (B
              ? ((W.lineMaskBG.style.display = 'none'), (W.lineMaskShape.style.display = 'inline'))
              : ((W.lineMaskBG.style.display = 'inline'), (W.lineMaskShape.style.display = 'none')),
            (G = !0)),
          ['x', 'y'].forEach(function (e) {
            var t = 'lineMask_' + e
          ...
          Xe(W, F, 'caps_enabled', (B = R.caps_enabled)) &&
            ((W.lineMaskCaps.style.display = W.lineOutlineMaskCaps.style.display =
              B ? 'inline' : 'none'),
            (G = !0),
          ...
          R.caps_enabled &&
            ([0, 1].forEach(function (e) {
              var t
              Xe(W, F.capsMaskAnchor_enabledSE, e, (B = R.capsMaskAnchor_enabledSE[e])) &&
                ((W.capsMaskAnchorSE[e].style.display = B ? 'inline' : 'none'),
                (G = !0),
                re && je(W, W.lineMask)),
                R.capsMaskAnchor_enabledSE[e] &&
                  (Fe((t = R.capsMaskAnchor_pathDataSE[e]), F.capsMaskAnchor_pathDataSE[e]) &&
                  ...
                  ) && ((W.capsMaskAnchorSE[e].style.strokeWidth = B + 'px'), (G = !0)))
            }),
            Xe(W, F, 'capsMaskMarker_enabled', (B = R.capsMaskMarker_enabled)) &&
              ((W.capsMaskLine.style.display = B ? 'inline' : 'none'), (G = !0)),
            R.capsMaskMarker_enabled &&
              [0, 1].forEach(function (n) {
                var e = R.capsMaskMarker_plugSE[n],
                  t = e !== Y ? X[q[e]] : null,
                  a = Ze(n, t)
                Xe(W, F.capsMaskMarker_enabledSE, n, (B = R.capsMaskMarker_enabledSE[n])) &&
                  ...
                  R.capsMaskMarker_enabledSE[n] &&
                    ...
                    ['markerWidth', 'markerHeight'].forEach(function (e) {
                      ...
                      Xe(W, F[t], n, (B = R[t][n])) &&
                        ((W.capsMaskMarkerSE[n][e].baseVal.value = B), (G = !0))
                    }))
              }))),
      ...
      t.effect &&
        ...
        Object.keys(Z).forEach(function (e) {
          ...
          Xe(D, H, n, (z = j[n]))
            ...
            : z && ke(e, H[a]) && (t.remove(D), (H[n] = !0), (H[a] = we(e)), t.init(D))
        })),
  ...
  function tt(e, t, n, a) {
    ...
    ;(i.show_on = t),
      n &&
        w[n] &&
        ((i.show_effect = n), (i.show_animOptions = et(he(a) ? a : {}, w[n].defaultAnimOptions))),
      ...
      l.show_effect || l.show_animOptions
        ? i.show_inAnim
          ? ((n = l.show_effect ? w[o.show_effect].stop(e, !0, !0) : w[o.show_effect].stop(e)),
            r(),
  ...
  function it(s, u) {
    ...
    function v(e, t, n, a, i, o, l) {
      ...
      return (
        ...
        null != l.container[l.key] || l.acceptsAuto || ((l.container[l.key] = l.default), (r = !0)),
        r
      )
    }
    function E(e, t, n, a, i, o, l, r, s) {
      ...
      return (
        ...
        null != l.container[l.key] || l.acceptsAuto || ((l.container[l.key] = l.default), (u = !0)),
        u
      )
    }
    if (
      ...
      ['start', 'end'].forEach(function (e, t) {
        ...
        if (n && (Me(n) || (a = I(n, 'anchor'))) && n !== S.anchorSE[t]) {
          if (
            (!1 !== s.optionIsAttach.anchorSE[t] && at(s, _e[S.anchorSE[t]._id]),
            a && !nt(s, _e[n._id], e))
          )
    ...
    i &&
      (c = (function (e, t) {
        ...
        !1 !== s.optionIsAttach.anchorSE[0] ? _e[S.anchorSE[0]._id].element : S.anchorSE[0],
        !1 !== s.optionIsAttach.anchorSE[1] ? _e[S.anchorSE[1]._id].element : S.anchorSE[1]
      )) !== s.baseWindow &&
      ((e = c),
      (f = (n = s).aplStats),
      (y = e.document),
      ...
      (l.href.baseVal = '#' + c),
      (n.lineMaskShape = l = n.lineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.className.baseVal = C + '-line-mask-shape'),
      (l.href.baseVal = '#' + r),
      (l.style.display = 'none'),
      (n.lineMaskCaps = l = n.lineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + p),
      (n.lineOutlineMask = k(x((e = m + '-line-outline-mask')))),
      ((l = n.lineOutlineMask.appendChild(y.createElementNS(ae, 'use'))).href.baseVal = '#' + c),
      (n.lineOutlineMaskShape = l = n.lineOutlineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.className.baseVal = C + '-line-outline-mask-shape'),
      (l.href.baseVal = '#' + r),
      (n.lineOutlineMaskCaps = l = n.lineOutlineMask.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + p),
      (n.face = t.appendChild(y.createElementNS(ae, 'g'))),
      (n.lineFace = l = n.face.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + h),
      (n.lineOutlineFace = l = n.face.appendChild(y.createElementNS(ae, 'use'))),
      (l.href.baseVal = '#' + h),
      (l.style.mask = 'url(#' + e + ')'),
      (l.style.display = 'none'),
      ...
      (g.line = g.plug = g.lineOutline = g.plugOutline = g.faces = g.effect = !0)),
          ...
          (Array.isArray(e)
            ? pe(e[0]) &&
              ...
              Array.isArray(S.socketGravitySE[t]) &&
                ...
                (i = !1))
            : ((e + '').toLowerCase() === D ? (i = null) : pe(e) && 0 <= e && (i = e),
              i === S.socketGravitySE[t] && (i = !1)),
          !1 !== i && ((S.socketGravitySE[t] = i), (g.position = !0)))
      }),
      (g.line = E(S, u, 'color', null, 'lineColor', null, ue.lineColor, null, !0) || g.line),
      (g.line =
      ...
      (g.lineOutline =
        E(S, u, 'outline', null, 'lineOutlineEnabled', null, ue.lineOutlineEnabled) ||
        g.lineOutline),
      (g.lineOutline =
        E(S, u, 'outlineColor', null, 'lineOutlineColor', null, ue.lineOutlineColor, null, !0) ||
        g.lineOutline),
      (g.lineOutline =
        E(S, u, 'outlineSize', null, 'lineOutlineSize', null, ue.lineOutlineSize, function (e) {
          return 0 < e && e <= 0.48
        }) || g.lineOutline),
      ['startPlugOutline', 'endPlugOutline'].forEach(function (e, t) {
        ;(g.plugOutline =
          E(S, u, e, null, 'plugOutlineEnabledSE', t, ue.plugOutlineEnabledSE[t]) || g.plugOutline),
          (g.plugOutline =
            E(S, u, e + 'Color', 'string', 'plugOutlineColorSE', t, null, null, !0) ||
            g.plugOutline),
          (g.plugOutline =
            E(
              S,
      ...
      ['startLabel', 'endLabel', 'middleLabel'].forEach(function (e, t) {
        ...
        if (
          ...
          if ((S.labelSEM[t] && (at(s, _e[S.labelSEM[t]._id]), (S.labelSEM[t] = '')), o)) {
            if (
              (r
                ? (a = _e[(i = o)._id]).boundTargets.slice().forEach(function (e) {
      ...
      Object.keys(Z).forEach(function (a) {
          ...
          return (
            e.hasOwnProperty('animation')
              ? he(e.animation)
                ...
                : ((t = !!e.animation), (s.curStats[n] = t ? et({}, o.defaultAnimOptions) : null))
              : ((t = !!o.defaultEnabled),
        ...
        u.hasOwnProperty(a) &&
          ...
          he(e)
            ...
            : (t = s.curStats[n] = !!e) &&
              ((s.curStats[i] = l({})), o.anim && (s.curStats[i].animation = r({}))),
        ...
        update: function (t) {
          ...
          ;(n.dash_len = i.len || 2 * a.line_strokeWidth),
            ...
            (o = Xe(t, a, 'dash_gap', n.dash_gap) || o) &&
              (t.lineFace.style.strokeDasharray = a.dash_len + ',' + a.dash_gap),
            n.dash_animOptions
              ? ((o = Xe(t, a, 'dash_maxOffset', n.dash_maxOffset)),
                a.dash_animOptions &&
                  (o || ke(n.dash_animOptions, a.dash_animOptions)) &&
                  (n.dash_animId && ((e = g.stop(n.dash_animId)), g.remove(n.dash_animId)),
              ...
              : a.dash_animOptions &&
                (n.dash_animId && (g.remove(n.dash_animId), (n.dash_animId = null)),
              ...
              Xe(a, o.gradient_colorSE, t, (n = i.gradient_colorSE[t])) &&
                ...
                ['x', 'y'].forEach(function (e) {
                  ;(n = i.gradient_pointSE[t][e]) !== o.gradient_pointSE[t][e] &&
                    (a.efc_gradient_gradient[e + (t + 1)].baseVal.value = o.gradient_pointSE[t][e] =
                      n)
                })
            })
        }
        ...
        init: function (t) {
          var e,
            ...
            s =
              ...
              (n = r),
              (i = {}),
              'boolean' != typeof u && (u = !!window.SVGFEDropShadowElement && !re),
              (i.elmsAppend = [(i.elmFilter = o = e.createElementNS(ae, 'filter'))]),
              (o.filterUnits.baseVal = SVGUnitTypes.SVG_UNIT_TYPE_USERSPACEONUSE),
              o.x.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX, 0),
              o.y.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX, 0),
              o.width.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE, 100),
              o.height.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PERCENTAGE, 100),
              (o.id = n),
              u
                ? ((i.elmOffset =
                    i.elmBlur =
                ...
                : ((i.elmBlur = o.appendChild(e.createElementNS(ae, 'feGaussianBlur'))),
                  (i.elmOffset = a = o.appendChild(e.createElementNS(ae, 'feOffset'))),
                  (a.result.baseVal = 'offsetblur'),
                  (a = o.appendChild(e.createElementNS(ae, 'feFlood'))),
                  (i.styleFlood = a.style),
                  ((a = o.appendChild(e.createElementNS(ae, 'feComposite'))).in2.baseVal =
                    'offsetblur'),
                  (a.operator.baseVal = SVGFECompositeElement.SVG_FECOMPOSITE_OPERATOR_IN),
                  (a = o.appendChild(e.createElementNS(ae, 'feMerge'))).appendChild(
                    e.createElementNS(ae, 'feMergeNode')
                  ),
                  (a.appendChild(e.createElementNS(ae, 'feMergeNode')).in1.baseVal =
                    'SourceGraphic')),
              i)
          ...
          null != o.dropShadow_dx &&
            ...
            ['x', 'y'].forEach(function (e) {
              var t,
                n = 'dropShadow_' + e
              ;(o[n] = t = i[e + '1']),
                Xe(a, l, n, t) && (a.efc_dropShadow_elmFilter[e].baseVal.value = t)
            }))
        }
      }
    }),
    ...
    (w = {
      none: {
        ...
        stop: function (e, t, n) {
          var a = e.curStats
          return (
            (n = null != n ? n : e.aplStats.show_on), (a.show_inAnim = !1), t && Je(e, n), n ? 1 : 0
          )
        }
      },
      fade: {
          ...
          t.show_animId && g.remove(t.show_animId),
            (t.show_animId = g.add(
              ...
              function (e, t) {
                t
                  ? w.fade.stop(n, !0)
                  : ((n.svg.style.opacity = e + ''), ie && (je(n, n.svg), He(n)))
              },
                ...
                if (0 === e) n = [[o[0][0], o[0][0]]]
                  ...
                  t &&
                    (2 === (a = o[i]).length
                      ...
                      : ((e = Ne(a[0], a[1], a[2], a[3], We(a[0], a[1], a[2], a[3], t))),
                        n.push([a[0], e.fromP1, e.fromP2, e])))
                }
                return n
              },
              function (e, t) {
                t ? w.draw.stop(n, !0) : ((n.pathList.animVal = e), $e(n, { path: !0 }))
              },
              a.show_animOptions.duration,
              1,
              a.show_animOptions.timing,
    ...
    (O = {
      pointAnchor: {
        ...
        removeOption: function (e, t) {
          ...
          i === e && (i = e === document.body ? new M(O.pointAnchor, [i]) : document.body),
            (a[t.optionName] = i),
            it(n, a)
        },
      ...
      areaAnchor: {
          ...
          return (
            ...
            'circle' === e.shape
              ...
              : 'polygon' === e.shape &&
                ...
                : ((a.shape = 'rect'), (a.radius = pe(e.radius) && 0 <= e.radius ? e.radius : 0)),
            ('rect' !== a.shape && 'circle' !== a.shape) ||
              ...
              (a.x[1] || a.y[1] || a.width[1] || a.height[1]) && (a.hasRatio = !0)),
        ...
        update: function (t) {
          ...
          if (
            ...
            v.strokeWidth || (t.hasRatio && (v.elementWidth || v.elementHeight)))
          ) {
            switch (t.shape) {
              case 'rect':
                ;((c = {
                  ...
                  (p = S.strokeWidth / 2),
                  (s = (r = Math.min(c.width, c.height)) ? (r / 2) * Math.SQRT2 + p : 0),
              ...
              case 'circle':
                ;(l = {
                  ...
                  (S.pathListRel = [
                    ...
                    [e[1], { x: e[1].x + r, y: e[1].y }, { x: e[2].x, y: e[2].y - p }, e[2]],
                    [e[2], { x: e[2].x, y: e[2].y + p }, { x: e[3].x + r, y: e[3].y }, e[3]],
                    [e[3], { x: e[3].x - r, y: e[3].y }, { x: e[0].x, y: e[0].y + p }, e[0]],
                    []
                  ]),
          ...
          return (
            ...
            t.dash &&
              ...
              v.dash && (t.path.style.strokeDasharray = g.dashLen + ',' + g.dashGap)),
            (d = S.viewBoxBBox),
            (f = g.viewBoxBBox),
            ...
            ['x', 'y', 'width', 'height'].forEach(function (e) {
              ;(a = d[e]) !== f[e] &&
                ((y[e] = f[e] = a),
                (m[Q[e]] = a + ('x' === e || 'y' === e ? t.bodyOffset[e] : 0) + 'px'))
            }),
      ...
      mouseHoverAnchor: {
        ...
        init: function (a, i) {
          ...
          return (
            ...
            'inline' ===
            (n = a.element.ownerDocument.defaultView.getComputedStyle(a.element, '')).display
            ...
            a.style.display &&
              ((e = a.element.style.display), (a.element.style.display = a.style.display)),
            O.mouseHoverAnchor.dirKeys.forEach(function (e) {
              e = 'padding' + e[1]
                ...
                ? ((h = p.minHeight),
                  'content-box' === n.boxSizing
                    ...
                    : 'padding-box' === n.boxSizing &&
                      (h -= parseFloat(n.borderTopWidth) + parseFloat(n.borderBottomWidth)),
                  (a.style.height = h + 'px'))
                : (a.style.height = parseFloat(n.height) + (p.minHeight - s.height) + 'px')),
            ...
            i.showEffectName && w[i.showEffectName] && (a.showEffectName = o = i.showEffectName),
            (l = i.animOptions),
        ...
        bind: function (e, t) {
          ...
          return (
            ...
            e.enabled ||
              ((e.styleSave = O.mouseHoverAnchor.getStyles(e.elmStyle, Object.keys(e.style))),
      ...
      captionLabel: {
        ...
        init: function (l, t) {
          return (
            ...
            !!l.text &&
              ...
              (l.outlineColor = 'string' == typeof t.outlineColor ? t.outlineColor.trim() : '#fff'),
                  ...
                  (l.offset
                    ...
                    : ((t = l.height / 2),
                      ...
                      o.socketId === A || o.socketId === k
                        ? ((n.x = o.socketId === A ? o.x - t - l.width : o.x + t),
                          (n.y = i.y < o.y ? o.y + e + t : o.y - e - t - l.height))
                        : ((n.x = i.x < o.x ? o.x + e + t : o.x - e - t - l.width),
                          (n.y = o.socketId === b ? o.y - t - l.height : o.y + t))),
                  Xe(l, a, 'x', (t = n.x)) && (l.elmPosition.x.baseVal.getItem(0).value = t),
                  Xe(l, a, 'y', (t = n.y)) &&
              ...
              (l.updatePath = function (e) {
                ...
                e &&
                  ...
                  (t.x = e.x - l.width / 2),
                  (t.y = e.y - l.height / 2),
                  Xe(l, n, 'x', (e = t.x)) && (l.elmPosition.x.baseVal.getItem(0).value = e),
                  Xe(l, n, 'y', (e = t.y)) &&
          ...
          return (
            ...
            i && !h
              ? ((o = t.createElementNS(ae, 'defs')),
                ...
                ((t = e.appendChild(t.createElementNS(ae, 'use'))).href.baseVal = '#' + a),
        ...
        getMidPoint: function (e, t) {
          var n,
            ...
            r = i / 2 + (t || 0)
          if (r <= 0)
            return 2 === (n = e[0]).length ? Ve(n[0], n[1], 0) : Ne(n[0], n[1], n[2], n[3], 0)
          if (i <= r)
        ...
        initSvg: function (t, n) {
          ...
          ;['elmPosition', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function (e) {
            ...
            t.outlineColor &&
              ((a = e.height / 9),
              (i.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'),
      ...
      pathLabel: {
                  ...
                  ((2 === l.semIndex && !l.lineOffset) ||
                    ((t = n.pathData.reduce(function (e, t) {
                      ...
                      switch (t.type) {
                        ...
                        case 'C':
                          ;(n = { x: a[4], y: a[5] }),
                            i && (e += Te(i, { x: a[0], y: a[1] }, { x: a[2], y: a[3] }, n)),
                            (i = n)
                      }
                      return e
                    }, 0)),
                    ...
                    2 !== l.semIndex &&
                      ((o =
                        Math.max(o.attach_plugBackLenSE[l.semIndex] || 0, o.line_strokeWidth / 2) +
                        l.strokeWidth / 2 +
                        l.height / 4),
                      (e = (e += 0 === l.semIndex ? o : -o) < 0 ? 0 : t < e ? t : e)),
                    l.lineOffset && (e = (e += l.lineOffset) < 0 ? 0 : t < e ? t : e),
                    (n.startOffset = e),
                    Xe(l, a, 'startOffset', e) && (l.elmOffset.startOffset.baseVal.value = e)))
              }),
              (l.updateShow = function (e) {
                O.captionLabel.updateShow(l, e)
              }),
        ...
        getOffsetPathData: function (e, c, n) {
          ...
          return (
                    ...
                    ? ((a = d.points),
                      0 <=
                        (r =
                          ...
                          Math.atan2(e[0].y - e[1].y, e[1].x - e[0].x)) && r <= Math.PI
                        ...
                        : ((o = Pe(a[0], a[1], c)),
                          ...
                          (r = s.x - i.x),
                          (u = s.y - i.y),
                          (s = (-h * (l.x - i.x) + p * (l.y - i.y)) / (-r * h + p * u)),
                          (u = (r * (l.y - i.y) - u * (l.x - i.x)) / (-r * h + p * u)),
                          (n = (h =
                            0 <= s && s <= 1 && 0 <= u && u <= 1
                              ? { x: l.x + u * p, y: l.y + u * h }
                              : null)
                            ? { type: 'line', points: [(a[1] = h), t[1]] }
                            : ((a[1] = y(i, o) ? i : o), { type: 'line', points: [i, t[1]] })),
                          (d.len = Ae(a[0], a[1]))))
                    ...
                    points: (function (e, t, n, a, i, o) {
                      for (
                        var l,
                          ...
                          h = [],
                          p = 0;
                        (r = (90 - (l = Ne(e, t, n, a, p)).angle) * (Math.PI / 180)),
                          h.push({ x: l.x + Math.cos(r) * i, y: l.y + Math.sin(r) * i * -1 }),
                          !(1 <= p);
            ...
            f.forEach(function (e) {
              ...
              d =
                'line' === e.type
                  ? (e.inside &&
                      (d.len > c
                        ? (((t = d.points)[1] = Pe(t[0], t[1], -c)), (d.len = Ae(t[0], t[1])))
                        : ((d.points = null), (d.len = 0)),
                      e.len > c + n
                        ? (((t = e.points)[0] = Pe(t[1], t[0], -(c + n))), (e.len = Ae(t[0], t[1])))
            ...
            f.reduce(function (t, e) {
              ...
              return (
                n &&
                  ((a && y(n[0], a)) || t.push({ type: 'M', values: [n[0].x, n[0].y] }),
                  'line' === e.type
        ...
        newText: function (e, t, n, a) {
          ...
          return (
            ...
            l.startOffset.baseVal.newValueSpecifiedUnits(SVGLength.SVG_LENGTHTYPE_PX, 0),
            (l.textContent = e),
            ...
            a && !h
              ? ((o.id = e = n + '-text'),
                ...
                ((t = n.appendChild(t.createElementNS(ae, 'use'))).href.baseVal = '#' + e),
        ...
        initSvg: function (t, n) {
          ...
          ;['elmPosition', 'elmPath', 'elmOffset', 'styleFill', 'styleShow', 'elmsAppend'].forEach(
            function (e) {
              t[e] = o[e]
            }
          ),
            ...
            le && ((i = o.elmOffset.href.baseVal), (o.elmOffset.href.baseVal = '')),
            ...
            t.outlineColor &&
              ((a = e.height / 9),
              (o.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'),
