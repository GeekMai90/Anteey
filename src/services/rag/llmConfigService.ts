...
import { LLMConfig, LLMModelType } from '../../renderer/src/types/llm'
...
export class LLMConfigService {
  ...
  // 添加新配置
  async addConfig(model: string, apiKey: string): Promise<LLMConfig> {
  ...
  // 更新配置
  async updateConfig(id: string, apiKey: string): Promise<LLMConfig> {
    const now = new Date().toISOString()
